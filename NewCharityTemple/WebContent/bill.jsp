...
<div class="left-div"><h3>Request Date: <%=rs2.getString(21) %></h3></div>
...
<div class="left-div"><h3>UPI ID: <%=rs2.getString(24) %></h3></div>
...
<a href="continueUsingCharityTemple.jsp"><button class="button left-button">Continue</button></a>
<a onclick="window.print();"><button class="button right-button">Print Your Confirmation Slip</button></a>
<br><br><br><br>
<%
}
catch(Exception e){
